...
o = open("badvotesoutput.txt", "w") # open file, write - just our key, value pairs
for line in f:  
    ...
    if len(data) == 40:
        ...
        o.write("{0}\t{1}\n".format(settlement_name_english, bad_votes))

f.close()
o.close()

n = open("badvotesoutput.txt","r")  # open file, read-only
